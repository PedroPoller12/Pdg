...
urlpatterns = [
    ...
    path('clientes/reporte/', views.reporteClientes, name='cliente_reporte'),
    ...
    path('ordenes/reporte/', views.reporteOrdenes, name='orden_reporte'),
    ...
    path('productos/inventario/', views.reporteInventario, name='inventario_reporte'),
    path('productos/salida/', views.productoSalida, name='producto_salida'),
