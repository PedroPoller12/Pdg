...
class Producto(models.Model):
    ...
    descuento = models.IntegerField(validators=[int_list_validator(allow_negative=False)], blank=True, null=True)
...
class Orden(models.Model):
    ...
    monto_cacelado = models.FloatField(validators=[MinValueValidator(0.0)], blank=True, null=True)
...
class OrdenItem(models.Model):
    ...
    cantidad = models.IntegerField(validators=[int_list_validator(allow_negative=False)], null=True)#Cantidad de salida del producto, descuenta del stock del producto
